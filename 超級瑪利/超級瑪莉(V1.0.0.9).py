...
while True:
    ...
    test = Test.render(f" player_1.player_x: {player_1.player_x + player_1.map_x}  player_1.player_y: {player_1.player_object_map_original[4][4]} collision_button_list: {collision_button_list} press the 'Number' key  0 >> Home screen  1 >> level1    2 >> level2    space >> pause " , True, (0,0,0))    # 顯示參數(方便測試Debug用)
